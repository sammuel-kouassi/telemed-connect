    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Cette page n'existe pas ou a été déplacée lors de la refonte du portail.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Télémédecine Côte d'Ivoire — Portail national" },
      {
        name: "description",
        content:
          "Portail national de la télémédecine en Côte d'Ivoire : projets, annuaire des structures connectées, médiathèque et ressources du réseau RAFT.",
      },
      { name: "author", content: "RAFT Côte d'Ivoire" },
